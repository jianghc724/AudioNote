...
#        IBM_USERNAME = "abc"  # IBM Speech to Text usernames are strings of the form XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX
#        IBM_PASSWORD = "def"  # IBM Speech to Text passwords are mixed-case alphanumeric strings
#        try:
